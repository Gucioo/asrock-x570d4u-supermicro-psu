#!/bin/bash
# ---------------------------------------------------------------------------
# make_fru_x570d4u.sh   --   ASRock Rack X570D4U-2L2T stock BMC firmware
#
# Produces the SAME working firmware as make_debug_x570d4u.sh (Supermicro
# PWS-441P-1H PSU at i2c 0x3c: web-UI sensors + ipmitool sensors + debug shell)
# and ADDS "Option E": PSU model / serial / revision in the web UI, sourced
# LIVE from the PSU's IPMI FRU EEPROM at i2c bus 2 / 0x38.
#
...
# --- debug root shell (sysadmin -> /bin/sh + your password) ---
...
echo "PSU model/serial should appear in the web UI System Information PSU panel."
